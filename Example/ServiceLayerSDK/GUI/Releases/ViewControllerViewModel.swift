...
class ViewControllerViewModel: ViewControllerViewModeling {
    ...
    lazy var fetchResult: PageFetchResult<ReleasesPageEntity, ReleasesQuery> = {
        ...
        return PageFetchResult<ReleasesPageEntity, ReleasesQuery>(networkService: networkService, cachePolicy: .cachedThenLoad, pageSize: Constants.pageSize) { filterId -> NSFetchedResultsController<ReleasesPageEntity> in
...
class AlternativeViewControllerViewModel: ViewControllerViewModeling {
    ...
    lazy var fetchResult: FetchResult<ReleasesPageEntity> = {
        ...
        return FetchResult<ReleasesPageEntity>.customResult(fr: frc, pageSize: Constants.pageSize, load: { [weak self] range in
